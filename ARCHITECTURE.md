...
این سند اجزای اصلی Nexora، مرز داده‌ها و مسیرهای اصلی پردازش را توضیح می‌دهد. جزئیات نیازمندی‌های محصول در [SRS](documents/Nexora-SRS.pdf) و قواعد رابط در [DESIGN.md](DESIGN.md) قرار دارند.
