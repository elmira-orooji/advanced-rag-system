...
export interface Connector { id: string; document_set_id: string; connector_type: "website" | "github"; name: string; source_url: string; status: string; last_error: string | null; last_synced_at: string | null; schedule_enabled: boolean; schedule_interval: "hourly" | "daily" | "weekly"; next_sync_at: string | null; last_sync_summary: { discovered?: number; created?: number; updated?: number; unchanged?: number; deleted?: number }; created_at: string; }
