...
export default function UploadFilesPage() {
  ...
  return <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative flex h-full overflow-hidden">
    ...
    <aside className={`knowledge-chat-panel fixed bottom-0 right-0 top-16 z-50 flex w-[min(100%,400px)] flex-col border-s border-white/[.09] transition duration-300 xl:relative xl:inset-auto xl:z-20 ${chatOpen ? "translate-x-0 xl:w-[390px]" : "translate-x-full xl:w-0 xl:translate-x-0 xl:overflow-hidden"}`}>
      <div className="flex h-full w-[min(100vw,400px)] flex-col xl:w-[390px]">
        <header className="knowledge-assistant-header flex h-[74px] shrink-0 items-center justify-between px-5">
          ...
          <button onClick={() => setChatOpen(false)} className="knowledge-assistant-close app-icon-button grid size-9 shrink-0 place-items-center rounded-xl"><PanelRightClose size={17} className="hidden xl:block" /><X size={17} className="xl:hidden" /></button>
        </header>
